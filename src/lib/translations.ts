...
export const translations = {
  en: {
    ...
    package: "Package",
    planFree: "Free Trial (100 Cards, 1 Mo)",
    planPremium: "Premium (Unlimited, 3 Mo)",
  ...
  sw: {
    ...
    package: "Kifurushi",
    planFree: "Jaribio (Kadi 100, Mwezi 1)",
    planPremium: "Premium (Bila Kikomo, Miezi 3)",
